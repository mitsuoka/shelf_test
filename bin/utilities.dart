...
//
Future<StringBuffer> reqInfo(shelf.Request request){
  Completer cp = new Completer();
  var sb = new StringBuffer( '''Available shelf.request data for this HTTP request:
...
shelf.request.scriptName : ${request.scriptName}
